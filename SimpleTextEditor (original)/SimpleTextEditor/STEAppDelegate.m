...
- (void)initializeiCloudAccess {
    ...
    if (token == nil)
    {
        UIAlertView *alert = [[UIAlertView alloc]
                              ...
                              message:@"pls Log in to your iCloud account or create one"
                              delegate:self
...
//        }
        ...
        {   // iPhone 3GS, 4, and 4S and iPod Touch 3rd and 4th generation: 3.5 inch screen (diagonally measured)
            ...
            UIStoryboard *iPhone35Storyboard = [UIStoryboard storyboardWithName:@"main_ip4" bundle:nil];
